...
router.get(
  "/:id/comments",
  validateParams(schemas.objectId),
  userController.getProfileComments,
);
...
router.post(
  ...
  userController.commentOnProfile,
);
router.post(
  "/:id/tag",
  validateParams(schemas.objectId),
  validate(schemas.tagUser),
  userController.tagUser,
);
router.post(
  "/:id/report",
  validateParams(schemas.objectId),
...
router.put(
  "/me/privacy",
  validate(schemas.privacySettings),
