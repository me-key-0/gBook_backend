...
class CategoryController {
  public getAllCampuses = asyncHandler(
    ...
    async (req: Request, res: Response): Promise<void> => {
      ...
      ResponseHandler.success(
        res,
        {
          ...
          users,
          pagination: {
            // Add pagination details directly to the data object
            page: pageNum,
            limit: limitNum,
            total,
  ...
  public getCampusStats = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      const [totalUsers, totalGraduates, totalGuests, collegeCount] =
        await Promise.all([
  ...
  public getCollegeStats = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      const [totalUsers, totalGraduates, totalGuests, departmentCount] =
        await Promise.all([
