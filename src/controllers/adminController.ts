...
class AdminController {
  ...
  public getUserDetails = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      // Fetch user with populated fields, excluding password
  ...
  public deactivateUser = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      ...
      logger.info(
        `User ${userId} deactivated by admin ${req.userId}. Reason: ${reason}`
      );
  ...
  public activateUser = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      const { userId } = req.params;
  ...
  public reviewReport = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      ...
      logger.info(
        `Report ${reportId} reviewed by admin ${req.userId}. Status: ${status}, Action: ${action}`
      );
  ...
  public createQuestion = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      ...
      logger.info(
        `Question created by admin ${req.userId}: ${newQuestion._id}`
      );
  ...
  public updateTag = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      ...
      const tag = await Tag.findByIdAndUpdate(tagId, updates, {
        new: true,
        runValidators: true,
      });
  ...
  public createCampus = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  ...
  public createCollege = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  ...
  public createDepartment = asyncHandler(
    async (req: AuthenticatedRequest, res: Response): Promise<void> => {
      ...
      logger.info(
        `Department created by admin ${req.userId}: ${department._id}`
      );
